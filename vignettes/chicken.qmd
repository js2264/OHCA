...
using the `fourDNAData` interface and study A/B compartment remodeling in 
chiken cells during mitosis entry (from Gibcus et al. 2018). 
...
hics <- imap(hics, ~ getCompartments(
    .x, 
    resolution = 250000, 
    chromosomes = chrs, 
