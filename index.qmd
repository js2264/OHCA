...
- `R >= 4.3` is required. You can check that by typing `version` in an R console or in RStudio. If you do not have `R >= 4.3` installed, you will need to update your `R` version, as most extra dependencies 
will require `R >= 4.3`. 
