...
::: {.callout-note}
## Installing R 4.3 on Linux (Ubuntu 22.04)
Detailed instructions are available [here](https://github.com/js2264/setup_ubuntu)

To install pre-compiled version of `R 4.3.0`: 
